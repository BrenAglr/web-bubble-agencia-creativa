...
const ServiceList = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-8 space-y-6 text-softblack">
        ...
        return (
          <div key={name} className="pb-4 border-b border-gray-300">
            <button
              ...
              className={clsx(
                "w-full flex items-center justify-between text-left text-2xl font-seymour transition-all duration-300",
