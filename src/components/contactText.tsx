...
const ContactText = () => {
  return (
    <div className="flex flex-col h-full justify-start p-4 sm:p-10 text-softblack">
      ...
      <div className="transition">
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-full max-w-xl rounded-2xl p-6 sm:p-8 mb-8 space-y-6 text-gray-800
          bg-indigo/10 backdrop-blur-md border border-indigo/20 
          shadow-xl shadow-black/30 box-border"
        >
          ...
          <div className="flex gap-4 my-4">
            <a
              href="https://www.instagram.com/bubble.agencia?igsh=OHRvNGM2ODNzN2Np"
              target="_blank"
